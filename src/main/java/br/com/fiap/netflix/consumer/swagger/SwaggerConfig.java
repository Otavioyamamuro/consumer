package br.com.fiap.netflix.consumer.swagger;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors
                        .basePackage("br.com.fiap.netflix.consumer.controller"))
    ...
    private ApiInfo apiEndPointsInfo() {
        ...
        apiInfoBuilder.title("Api de Cadastro e Consulta os LIKES");
